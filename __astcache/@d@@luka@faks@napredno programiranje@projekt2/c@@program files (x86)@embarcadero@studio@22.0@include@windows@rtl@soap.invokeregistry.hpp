...
// (DO NOT EDIT: machine generated header) 'Soap.InvokeRegistry.pas' rev: 35.00 (Windows)
...
public:
	...
	System::TClass __fastcall URIToClass(const System::UnicodeString URI, const System::UnicodeString Name, bool &IsScalar, System::TClass AInheritsFrom = 0x0)/* overload */;
