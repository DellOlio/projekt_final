...
// (DO NOT EDIT: machine generated header) 'Soap.SOAPHTTPTrans.pas' rev: 35.00 (Windows)
...
class DELPHICLASS TClientCertExt;
...
public:
	/* TComponent.Create */ inline __fastcall virtual TClientCertExt(System::Classes::TComponent* AOwner) : TClientCert(AOwner) { }
	/* TComponent.Destroy */ inline __fastcall virtual ~TClientCertExt() { }
