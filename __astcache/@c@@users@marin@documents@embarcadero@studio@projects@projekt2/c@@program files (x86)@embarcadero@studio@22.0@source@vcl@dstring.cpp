...
namespace System
{
...
#elif defined(__APPLE__) || defined(__arm__) || defined(__linux__)
  ...
  AnsiStringBase::AnsiStringBase(char32_t src, int codePage) : Data(0)
  {
    char32_t str[] = {src, '\0'};
    UnicodeString ustr(str, 1);
    *this = AnsiStringBase(ustr, codePage);
  }
...
#undef sprintf
  ...
  int __cdecl AnsiStringBase::vprintf(int codePage, const char* format, va_list paramList)
  {
    ...
    int size = vsnprintf(NULL, 0, format, temp);
#else
  ...
  // ---------------------------------------------------------------------------------------------------------
  // This is a hack to cope w/ Delphi mangling 'RawByteString' and 'UTF8String' as distinct types instead of 
  // aliases of AnsiStringT<CP>, as we do on Windows.
  // ---------------------------------------------------------------------------------------------------------
  RawByteString::RawByteString()
  {}

  RawByteString::RawByteString(const char* src, int byteLen) : _BaseAnsiStringType(src, byteLen)
  {}

  RawByteString::RawByteString(const wchar_t* src, int numwchar) : _BaseAnsiStringType(src, numwchar)
  {}

  RawByteString::RawByteString(const char16_t* src, int numChar16) : _BaseAnsiStringType(src, numChar16)
  {}

  RawByteString::RawByteString(const char32_t* src, int numChar32) : _BaseAnsiStringType(src, numChar32)
  {}

  RawByteString::RawByteString(char src) : _BaseAnsiStringType(src)
  {}

  RawByteString::RawByteString(System::WideChar src) : _BaseAnsiStringType(src)
  {}

  RawByteString::RawByteString(char32_t src) : _BaseAnsiStringType(src)
  {}

  RawByteString::RawByteString(short src) : _BaseAnsiStringType(src)
  {}

  RawByteString::RawByteString(unsigned short src) : _BaseAnsiStringType(src)
  {}

  RawByteString::RawByteString(int src) : _BaseAnsiStringType(src)
  {}

  RawByteString::RawByteString(unsigned int src) : _BaseAnsiStringType(src)
  {}

  RawByteString::RawByteString(long src) : _BaseAnsiStringType(src)
  {}

  RawByteString::RawByteString(unsigned long src) : _BaseAnsiStringType(src)
  {}

  RawByteString::RawByteString(__int64 src) : _BaseAnsiStringType(src)
  {}

  RawByteString::RawByteString(unsigned __int64 src) : _BaseAnsiStringType(src)
  {}

  RawByteString::RawByteString(double src) : _BaseAnsiStringType(src)
  {}

  RawByteString::RawByteString(const UnicodeString& src) : _BaseAnsiStringType(src)
  {}

  RawByteString::RawByteString(const WideString& src) : _BaseAnsiStringType(src)
  {}

  RawByteString::RawByteString(const RawByteString& src) : _BaseAnsiStringType(src)
  {}

  RawByteString::RawByteString(const UTF8String& src) : _BaseAnsiStringType(src)
  {}

  RawByteString::RawByteString(const AnsiString& src) : _BaseAnsiStringType(src)
  {}
  
  RawByteString& RawByteString::operator=(const RawByteString& rhs) {
    _BaseAnsiStringType::operator=(rhs);
    return *this;
  }
  ...
  UTF8String::UTF8String(const char* src, int byteLen) : _BaseAnsiStringType(src, byteLen)
  {}

  UTF8String::UTF8String(const wchar_t* src, int numwchar) : _BaseAnsiStringType(src, numwchar)
  {}

  UTF8String::UTF8String(const char16_t* src, int numChar16) : _BaseAnsiStringType(src, numChar16)
  {}

  UTF8String::UTF8String(const char32_t* src, int numChar32) : _BaseAnsiStringType(src, numChar32)
  {}

  UTF8String::UTF8String(char src) : _BaseAnsiStringType(src)
  {}

  UTF8String::UTF8String(System::WideChar src) : _BaseAnsiStringType(src)
  {}

  UTF8String::UTF8String(char32_t src) : _BaseAnsiStringType(src)
  {}

  UTF8String::UTF8String(short src) : _BaseAnsiStringType(src)
  {}

  UTF8String::UTF8String(unsigned short src) : _BaseAnsiStringType(src)
  {}

  UTF8String::UTF8String(int src) : _BaseAnsiStringType(src)
  {}

  UTF8String::UTF8String(unsigned int src) : _BaseAnsiStringType(src)
  {}

  UTF8String::UTF8String(long src) : _BaseAnsiStringType(src)
  {}

  UTF8String::UTF8String(unsigned long src) : _BaseAnsiStringType(src)
  {}

  UTF8String::UTF8String(__int64 src) : _BaseAnsiStringType(src)
  {}

  UTF8String::UTF8String(unsigned __int64 src) : _BaseAnsiStringType(src)
  {}

  UTF8String::UTF8String(double src) : _BaseAnsiStringType(src)
  {}

  UTF8String::UTF8String(const UnicodeString& src) : _BaseAnsiStringType(src)
  {}

  UTF8String::UTF8String(const WideString& src) : _BaseAnsiStringType(src)
  {}

  UTF8String::UTF8String(const UTF8String& src) : _BaseAnsiStringType(src)
  {}

  UTF8String::UTF8String(const RawByteString& src) : _BaseAnsiStringType(src)
  {}

  UTF8String::UTF8String(const AnsiString& src) : _BaseAnsiStringType(src)
  {}
  ...
  int AnsiRefCount(const AnsiStringBase& str)
  {
    return StringRefCount(*PRawByteString(&str));
  }

  Word AnsiCodePage(const AnsiStringBase& str)
  {
    return StringCodePage(*PRawByteString(&str));
  }
